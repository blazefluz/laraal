            ...
            <div class="col-md-12">
                <div class="panel panel-white shadow  rounded">
                    <div class="panel-body">
                            <form  action="{{route('save-lottery')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group col-md-8 col-sm-8">
                                                    <label for="title" class=" control-label">Title</label>
                                                        <input type="text" name="title" class="form-control" id="title" placeholder="1 Plot of land" required>
                                                </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group col-md-12 col-sm-6">
                                                    <label for="startdate" class=" control-label">Start date</label>
                                                        <input type="text" name="startdate" class="form-control date-picker" id="startdate" required>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group col-md-12 col-sm-6">
                                                    <label for="enddate" class=" control-label">End date</label>
                                                        <input type="text" name="enddate" class="form-control date-picker" id="enddate" required>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                            ...
                                            <div class="col-md-12">
                                                    ...
                                                    <div class="form-group col-md-4 col-sm-4">
                                                        <label for="currency" class="control-label">Max Bet(play)</label>
                                                          <input type="number" min="1" name="max_play"  class="form-control">
                                                    </div>
                                                    <div class="form-group col-md-4 col-sm-4">
                                                        <label for="currency" class="control-label">Number of Winners</label>
                                                          <input type="number" min="1" name="no_winners"  class="form-control">
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group col-md-12">
                                                    <label for="desc" class="control-label">Description</label>
                                                       ...
                                                       <textarea class="form-control" name="desc" id="desc" cols="30" rows="10" placeholder="Write description" required></textarea>           
                                                </div>
                                            </div>
